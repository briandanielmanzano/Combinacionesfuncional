...
def saludo (request):
    ...
    temascurso=["Plantillas","Modelos","formularios","Despliegue"]

    # doc_externo=open("C:/Users/ACER/OneDrive/Escritorio/proyectosdjango/Proyecto1/Proyecto1/plantillas/miplantilla.html")
    ...
    # ctx=Context({"temas":temascurso,"nombre_persona":p1.nombre,"apellido_persona":p1.apellido,"fecha":ahora})
    ctx={"temas":temascurso,"nombre_persona":p1.nombre,"apellido_persona":p1.apellido,"fecha":ahora}
